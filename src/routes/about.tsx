      ...
      <section className="bg-wood-50 py-16 px-6 lg:px-20">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="lg:w-1/2 w-full">
            <div className="w-full max-w-md aspect-square bg-wood-200 rounded-2xl flex items-center justify-center mx-auto">
              <span className="text-wood-400">Team Photo</span>
            </div>
          </div>
          <div className="lg:w-1/2">
            <h2 className="text-wood-950 text-2xl font-bold">Our Story</h2>
            ...
            <ul className="mt-6 flex flex-col gap-3">
              {values.map((v) => (
                <li key={v} className="flex items-center gap-3">
                  ...
                  <span className="text-wood-950 font-semibold">{v}</span>
                </li>
              ))}
            </ul>
          </div>
